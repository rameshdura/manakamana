  ...
  return (
    <section className="py-16 bg-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Tab Navigation */}
        <div className="flex flex-col sm:flex-row justify-center items-center mb-12 border-b border-stone-200 pb-6">
          <button
            onClick={() => setActiveTab('featured')}
            className={`px-6 py-3 font-semibold text-sm tracking-wide uppercase transition-all duration-300 mb-4 sm:mb-0 sm:mr-8
              ${activeTab === 'featured'
          ...
          <button
            ...
            className={`px-6 py-3 font-semibold text-sm tracking-wide uppercase transition-all duration-300 mb-4 sm:mb-0
              ${activeTab === 'popular'
                ? 'text-primary border-b-2 border-primary'
                : 'text-stone-600 dark:text-stone-300 hover:text-stone-900 dark:hover:text-stone-100'
              }`
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {productsToDisplay.map((product) => (
            <Link 
              ...
              className="group bg-white dark:bg-[hsl(224_40%_9%)] rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden"
            >
              <div className="aspect-square relative overflow-hidden">
                ...
                {activeTab === 'popular' && (
                  <div className="absolute top-4 left-4 bg-primary dark:bg-[hsl(224_80%_65%)] text-white dark:text-[hsl(224_40%_6%)] text-xs px-3 py-1 rounded-full font-medium">
                    Popular
                  </div>
                )}
              </div>
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-stone-900 dark:text-stone-100 mb-2 leading-tight">{product.name}</h3>
                <p className="text-stone-600 dark:text-stone-300 text-sm mb-4">{product.desc}</p>
